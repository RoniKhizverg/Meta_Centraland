...
const userLoginRouter = require('./routes/logsIn');

app.use('/plots', plotsRouter)
app.use('/signupUsers', signupRouter)
app.use('/logsIn', userLoginRouter)
app.listen(process.env.PORT, () => console.log('Server started')); //tell what the port we want to listen on in our case-3000 when the server ges started.