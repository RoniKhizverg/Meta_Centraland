...
const placeRouter = require('./routes/places'); //to route all of our places information
app.use('/places', placeRouter) //we want to use this whenever we query places
'localhost: 3000/places' //this url is going to go into places router(to places.js)
